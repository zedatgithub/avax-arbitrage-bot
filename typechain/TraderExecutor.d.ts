...
interface TraderExecutorInterface extends ethers.utils.Interface {
  functions: {
    "arbTradeFlash(address,uint256,uint256,tuple[])": FunctionFragment;
...
export class TraderExecutor extends BaseContract {
  ...
  interface: TraderExecutorInterface;
  ...
  functions: {
    arbTradeFlash(
      ...
      calls: { target: string; data: BytesLike }[],
